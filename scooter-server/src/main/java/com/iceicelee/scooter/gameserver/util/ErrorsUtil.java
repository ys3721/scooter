package com.iceicelee.scooter.gameserver.util;
...
public class ErrorsUtil {
	 ...
	 *
	 * @param errorCode 错误代码 @see {@link com.iceicelee.scooter.gameserver.processor.constants.CommonErrorLogInfo}
	...
	public static String error(String errorCode, String origin, String param) {
		StringBuilder _errorStr = new StringBuilder("[").append(errorCode)
	 ...
	 */
	@Deprecated
	public static String errorWithCaller(String errorCode, String cause,
										 String callerDesc) {
		return new StringBuilder().append("Err:").append(errorCode)
				.append(",Cause:").append(cause).append(",Caller:")
